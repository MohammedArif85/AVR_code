...
#define GET_GDO2_LOW 	(!(PINB & 0x02))
#define GET_GDO2_HIGH 	(PINB & 0x02)
#define GET_MISO_LOW 	(!(PINB & 0x40))
#define GET_MISO_HIGH 	(PINB & 0x40)


#define CS_LOW		sbi(CC2500_PORT,CS)
#define CS_HIGH		cbi(CC2500_PORT,CS)
