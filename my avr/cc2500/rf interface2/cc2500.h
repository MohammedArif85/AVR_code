...
//----------------------------------------------------------------------------------
// Hardware CS MOSI MISO SCK
//----------------------------------------------------------------------------------
#define CC2500_DDR DDRB
#define CC2500_PORT PORTB
#define CC2500_PIN PINB
...
#define GET_GDO0_LOW 	(!(PINB & 0x04))
#define GET_GDO0_HIGH 	(PINB & 0x04)
#define GET_GDO2_LOW 	(bit_is_clear(CC2500_PIN,GDO2))
#define GET_GDO2_HIGH 	(bit_is_set(CC2500_PIN,GDO2))

#define GET_MISO_HIGH 	(bit_is_set(CC2500_PIN,MISO))


#define CS_LOW		cbi(CC2500_PORT,CS)
#define CS_HIGH		sbi(CC2500_PORT,CS)

#define MOSI_LOW	cbi(CC2500_PORT,MOSI)
#define MOSI_HIGH	sbi(CC2500_PORT,MOSI)

#define MISO_LOW	cbi(CC2500_PORT,MISO)
#define MISO_HIGH	sbi(CC2500_PORT,MISO)

#define SCK_LOW		cbi(CC2500_PORT,SCK)
#define SCK_HIGH	cbi(CC2500_PORT,SCK)
