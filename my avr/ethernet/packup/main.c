...
#define WEBSERVER_VHOST "logicbrigade.com"
...
#define LEDOFF PORTA|=(1<<PORTA6)
// set output to GND, red LED on
#define LEDON PORTA&=~(1<<PORTA6)
        ...
        while(1){
                ...
                if(plen==0){
                        ...
                        if (start_web_client==1){
							   ...
							   if((PIND&0x03)==0x00)
							   sprintf(urlvarstr,"?a=on&b=on&t=1114");
							   else if((PIND&0x03)==0x01)
							   sprintf(urlvarstr,"?a=on&b=off&t=1114");
							   else if((PIND&0x03)==0x02)
							   sprintf(urlvarstr,"?a=off&b=on&t=1114");
							   else
							   sprintf(urlvarstr,"?a=off&b=off&t=1114");
							   
                                client_browse_url(PSTR("/kukrokoo/tdata.php"),urlvarstr,PSTR(WEBSERVER_VHOST),&browserresult_callback);
                        }
